...
from lib.dataset.squad_dataset_multiple import SquadDatasetMultiple
...
def the_main_function(name_of_model,config_dir='config', update_dict=None,data_folder_path=DEFAULT_DATA_FOLDER_PATH,config_filename = DEFAULT_CONFIG_FILENAME,h5filename = DEFAULT_H5_FILENAME):
    ...
    dataset = SquadDatasetMultiple(dataset_h5=h5filename,
                           data_path=data_folder_path+"/",
                           ignore_case=True)

    train_data, valid_data, test_data1, test_data2, test_data3, test_data4 =\
        dataset.get_data(train_size=TRAIN_SIZE, valid_size=VALID_SIZE, test_size=TEST_SIZE)
    print "STARTING!!!!!!!!!!!!\n\n"
    # print_shape_info(test_data1)
    # print_shape_info(test_data2)
    # print_shape_info(test_data3)
    # print_shape_info(test_data4)
    #
    # print "\n\n"
    # print_data_samples(dataset, test_data1, 0, 1)
    # print "\n\n"
    # print_data_samples(dataset, test_data2, 0, 1)
    # print "\n\n"
    # print_data_samples(dataset, test_data3,0, 1)
    # print "\n\n"
    # print_data_samples(dataset, test_data4,0, 1)
    # print "\n\n"
    ...
    test_f1, test_em, test_nll_loss = evaluate_error_analysis(model=_model, data=test_data_to_use, criterion=criterion,
                                               trim_function=squad_trim, char_level_func=add_char_level_stuff,
                                               word_id2word=word_vocab, char_word2id=char_word2id,
                                               batch_size=valid_batch_size, enable_cuda=model_config['scheduling']['enable_cuda'])
